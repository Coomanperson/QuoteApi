...
namespace QuoteService
{
    public class Startup
    {
        ...
        {
            var authenticationKey = Configuration.GetValue<string>("AuthenticationKey");
            ...
            services.AddSingleton<IAuthenticationService>(new AuthenticationService(authenticationKey));
        }
